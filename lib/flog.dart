...
class Flog {
  ...
  static void critical(String text) {
    _writeLog(text: text, label: "CRITICAL", color: LogColor.red);
  }
  ...
  static void info(String text) {
    _writeLog(text: text, label: "INFO", color: LogColor.blue);
  }
  ...
  static void _writeLog({
    ...
    if (useSeparators) {
      if (Platform.isIOS || Platform.isMacOS) {
        ...
        //ignore: avoid_print
        print(
            '${color.value}${LogWeight.bold.value} ------------------------------------------------------------------------------------------');
      }
    }
    if (kDebugMode && isDebugModeEnabled) {
      if (useTimestamps) {
        ...
        if (Platform.isIOS || Platform.isMacOS) {
          ...
          //ignore: avoid_print
          print(
              ' ${color.value}${LogWeight.bold.value}[$label] [${now.toString()}]:${LogWeight.normal.value}${color.value} $text${LogWeight.normal.value}');
        }
      } else {
        if (Platform.isIOS || Platform.isMacOS) {
          //ignore: avoid_print
          ...
          //ignore: avoid_print
          print(
              ' ${color.value}${LogWeight.bold.value}[$label]:${LogWeight.normal.value}${color.value} $text${LogWeight.normal.value}');
        }
      }
